...
export function ImageDropzone({
  ...
  return (
    <div
      className={cn(
        "w-[500px] h-[500px] rounded-md border bg-background relative flex justify-center shadow-sm",
    ...
    >
      ...
      />
      {url ? (
        <img src={url} alt="uploaded image" className=" object-center object-contain h-full" />
      ) : (
